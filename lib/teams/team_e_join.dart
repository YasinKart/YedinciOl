...
class TeamEJoinPage extends StatefulWidget {
  const TeamEJoinPage({super.key});

  @override
  State<TeamEJoinPage> createState() => _TeamEJoinPageState();
}

class _TeamEJoinPageState extends State<TeamEJoinPage> {
  ...
  void initState() {
    super.initState();
    dbRef = FirebaseDatabase.instance.ref().child('teame');
