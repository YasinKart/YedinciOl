...
class TeamCJoinPage extends StatefulWidget {
  const TeamCJoinPage({super.key});

  @override
  State<TeamCJoinPage> createState() => _TeamCJoinPageState();
}

class _TeamCJoinPageState extends State<TeamCJoinPage> {
  ...
  void initState() {
    super.initState();
    dbRef = FirebaseDatabase.instance.ref().child('teamc');
        ...
        leading: BackButton(
          onPressed: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const TeamCPage(),
              ),
            );
          },
        ),
