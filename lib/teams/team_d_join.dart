...
class TeamDJoinPage extends StatefulWidget {
  const TeamDJoinPage({super.key});

  @override
  State<TeamDJoinPage> createState() => _TeamDJoinPageState();
}

class _TeamDJoinPageState extends State<TeamDJoinPage> {
  ...
  void initState() {
    super.initState();
    dbRef = FirebaseDatabase.instance.ref().child('teamd');
        ...
        leading: BackButton(
          onPressed: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const TeamDPage(),
              ),
            );
          },
        ),
