...
class TeamBJoinPage extends StatefulWidget {
  const TeamBJoinPage({super.key});

  @override
  State<TeamBJoinPage> createState() => _TeamBJoinPageState();
}

class _TeamBJoinPageState extends State<TeamBJoinPage> {
  ...
  void initState() {
    super.initState();
    dbRef = FirebaseDatabase.instance.ref().child('teamb');
        ...
        leading: BackButton(
          onPressed: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const TeamBPage(),
              ),
            );
          },
        ),
